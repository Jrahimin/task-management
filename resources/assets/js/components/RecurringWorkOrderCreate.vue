<template>
    <div class="container">
        <fieldset>
            <legend><h3>New Recurring Job</h3></legend>

            <form class="form-horizontal" @submit.prevent="addRecurringWorkOrder">
                <div class="row">
                        ...
                        <div class="form-group" v-if="workorder.is_assigned==1">
                            ...
                            <div class="form-group" v-if="workorder.is_scheduled==1">
                                <div class="form-group row">
                                    <div class="col-md-4">
                                            <select class="form-control" v-model.number="workorder.appointment_day_add">
                                                ...
                                                <option value="11">11 Days after</option>
                                                <option value="12">12 Days after</option>
                                                <option value="13">13 Days after</option>
                                                <option value="14">14 Days after</option>
                                                <option value="15">15 Days after</option>
                                                <option value="16">16 Days after</option>
                                                <option value="17">17 Days after</option>
                                                <option value="18">18 Days after</option>
                                                <option value="19">19 Days after</option>
                                                <option value="20">20 Days after</option>
                                                <option value="21">21 Days after</option>
                                                <option value="22">22 Days after</option>
                                                <option value="23">23 Days after</option>
                                                <option value="24">24 Days after</option>
                                                <option value="25">25 Days after</option>
                                                <option value="26">26 Days after</option>
                                                <option value="27">27 Days after</option>
                                                <option value="28">28 Days after</option>
                                                <option value="29">29 Days after</option>
                                                <option value="30">30 Days after</option>
                                            </select>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="control-label">the Work Order is created</label>
                                    </div>
                                </div>

                                <div class="form-group row">

                                    <div class="col-md-5" v-if="workorder.is_all_day!=1">
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                <input type="time" step="900" v-model="workorder.appointment_start_time"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5" v-if="workorder.is_all_day!=1">
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                <input type="time" step="900" v-model="workorder.appointment_end_time"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="checkbox"><input type="checkbox" value="1" v-model.number="workorder.is_all_day"/>All day</label>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        data() {
            return {
                workorder: {
                    ...
                    appointment_day_add: '', appointment_start_time: '', appointment_end_time: '',

                    customer_location_id: '', location_name: '', address: '', city: '', state: '',
                    zip: '', country: '', zone: '', is_assigned: 0, is_scheduled: 0,

                    interval: '', frequency: '', start_date: '', end_date: '', time: '', end_occurance: '',
                    week_in_month: '', days_in_week: [], day_in_month: '', part_of_month: '',
                },
                customers: [], locations: [], contacts: [], equipments: [], contracts: [], other_locations: [],
                taxcodes: [], users: [], errors: [],
                other_customer_id: '', other_location: false, different_customer: false, end_on: '', month_choice: '',
            }
        },
        created() {
        ...
        methods: {
            ...
            addRecurringWorkOrder() {
                ...
                axios.post('recurring-jobs/add', this.workorder).then(response =>{
