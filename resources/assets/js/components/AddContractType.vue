<template>
    ...
    <div class="container">
        <fieldset>
            <legend><h3>New Contract Type</h3></legend>
            <form class="form-horizontal" @submit.prevent="addContractType">
...
<script>
    ...
    export default {
        ...
        methods:{
            addContractType(){
                axios.post('contract-type/add', this.contract).then(response =>{
