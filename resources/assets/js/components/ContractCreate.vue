<template>
    <div class="container">
        <fieldset>
            ...
            <form class="form-horizontal" @submit.prevent="addContract">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" v-model.number="contract.type">
                                ...
                                <option v-for="contract_type in contract_types" :value="contract_type.id">
                                    {{contract_type.name}}
                                </option>
                            </select>
                        </div>
...
import axios from 'axios'
    ...
    export default{
        created(){
            ...
            axios.get('contract-type/all').then(response => {
        ...
        data(){
            return{
                contract:{
                    name: '',status: '',start_date: '',end_date: '',hour_limit: '',money_limit: '',
                    unlimited: '',overage_allow: 0,type: '',contract_no: '',purchase_order_no: '',
                    description: '',terms: '',notes: '', subtotal: '', total: '', customer_id: '',
                    location_id: '',contact_id: '',tax_code_id: '',
                },
                is_expire: '', customers: [], locations: [], contacts: [], taxcodes: [], contract_types:[],
                limit_type: '', tax: 0, errors: [],
            }
        },
        methods:{
            addContract(){
                axios.post('contract/add', this.contract).then(response =>{
