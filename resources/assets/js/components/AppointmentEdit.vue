<template>
    <div class="container">
        <fieldset>
            <legend><h3>Edit Appointment</h3></legend>
            <form class="form-horizontal" @submit.prevent="editAppointment">
...
<script>
    ...
    export default {
        data(){
            return{
                appointment:{
                    subject: '',start_date: '',start_time: '',end_date: '', end_time: '',is_all_day: '',notes: '',
                ...
                appointment_id: this.$route.params.id, appointment_recurrence:'', recurrence_end: '',
                users: [], customers: [], errors: []
            }
        },
        methods:{
            editAppointment(){
                axios.post('appointment/edit/'+this.appointment_id, this.appointment).then(response =>{
        ...
        created(){
            axios.get('event/'+this.appointment_id).then(response => {
