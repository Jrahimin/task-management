...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_WorkOrderAll_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_WorkOrderAll_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_WorkOrderAll_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_WorkOrderCreate_vue__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_WorkOrderCreate_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_WorkOrderCreate_vue__);
/**
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#allWorkOrder',
    components: {
        workOrderAll: __WEBPACK_IMPORTED_MODULE_2__components_WorkOrderAll_vue___default.a
    }
});
...
var app2 = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#addWorkOrder',
    components: {
        workOrderAdd: __WEBPACK_IMPORTED_MODULE_3__components_WorkOrderCreate_vue___default.a
    }
});
...
Component.options.__file = "resources\\assets\\js\\components\\ChangeStatusWorkOrder.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-890b8698", Component.options)
  } else {
    hotAPI.reload("data-v-890b8698", Component.options)
  }
...
Component.options.__file = "resources\\assets\\js\\components\\WorkOrderCreate.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-40799f72", Component.options)
  } else {
    hotAPI.reload("data-v-40799f72", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(5)("66a3031d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-40799f72\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./WorkOrderCreate.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-40799f72\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./WorkOrderCreate.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('customer/all').then(function (response) {
            _this.customers = response.data;
        });
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('user/all').then(function (response) {
            _this.users = response.data;
        });
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('tax-code/all').then(function (response) {
            _this.taxcodes = response.data;
        });
    },

    methods: {
        generateElements: function generateElements(id) {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('location/all', { id: id }).then(function (response) {
                _this2.locations = response.data;
            });
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('contact-customer/all', { id: id }).then(function (response) {
                _this2.contacts = response.data;
            });
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('equipment-customer', { id: id }).then(function (response) {
                _this2.equipments = response.data;
                //console.log(response.data)
            });
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('contract-customer', { id: id }).then(function (response) {
                _this2.contracts = response.data;
                //console.log(response.data)
            });
        },
        differentCustomer: function differentCustomer() {
            this.different_customer = true;
            this.other_location = false;
        },
        differentCustomerLocation: function differentCustomerLocation(id) {
            var _this3 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('location/all', { id: id }).then(function (response) {
                _this3.other_locations = response.data;
            });
        },
        nonBillable: function nonBillable() {
        ...
        addWorkOrder: function addWorkOrder() {
            ...
            if (this.workorder.status == 2) {
                if (this.workorder.is_assigned == 0) alert("Please assign an user for assigned work order");
            }

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('work-order/add', this.workorder).then(function (response) {
                _this4.errors = response.data.message;
                if (_this4.errors == undefined) {
                    _this4.$router.push({ name: 'recurring-all' });
                }
            });
        }
    }
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("fieldset", [
      _c("legend", [_vm._v("New Work Order")]),
      _vm._v(" "),
      _c(
        "form",
        {
        ...
        [
                        ...
                        directives: [
                          {
                            ...
                            value: _vm.workorder.type,
                            expression: "workorder.type",
                  ...
                  _c("div", { staticClass: "col-md-5" }, [
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _c("option", { attrs: { value: "4" } }, [_vm._v("Low")])
                      ]
                    )
                  ])
                ]),
                      ...
                      "select",
                      {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.customer_id,
                            expression: "workorder.customer_id",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
                        on: {
                          change: [
                            ...
                            function($event) {
                              _vm.generateElements(_vm.workorder.customer_id)
                            }
                          ]
                        }
                      },
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.location_id,
                            expression: "workorder.location_id",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.contact_id,
                            expression: "workorder.contact_id",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.workorder.detailed_description,
                          expression: "workorder.detailed_description"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { rows: "4" },
                      domProps: { value: _vm.workorder.detailed_description },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.equipment_ids,
                            expression: "workorder.equipment_ids",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
                  ...
                  _c("div", { staticClass: "col-sm-5" }, [
                    _c("label", { staticClass: "radio-inline" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.is_billable,
                            expression: "workorder.is_billable",
                            modifiers: { number: true }
                          }
                        ],
                        ...
                        domProps: {
                          checked: _vm._q(
                            _vm.workorder.is_billable,
                            _vm._n("1")
                          )
                        },
                        on: {
                          click: function($event) {
                            ;(_vm.workorder.bill_to = 4),
                              (_vm.different_customer = false),
                              (_vm.other_location = false)
                          },
                          change: function($event) {
                            _vm.$set(_vm.workorder, "is_billable", _vm._n("1"))
                          }
                        }
                      }),
                      _vm._v("Billable")
                    ...
                    _c("label", { staticClass: "radio-inline" }, [
                      _c("input", {
                        ...
                        on: {
                          click: _vm.nonBillable,
                          change: function($event) {
                            _vm.$set(_vm.workorder, "is_billable", _vm._n("0"))
                          }
                        }
                      }),
                      _vm._v("Non-Billable")
                      ...
                      _c("div", { staticClass: "col-md-10" }, [
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.bill_to,
                                expression: "workorder.bill_to"
                              }
                            ],
                            attrs: { type: "radio", value: "4" },
                            domProps: {
                              checked: _vm._q(_vm.workorder.bill_to, "4")
                            },
                            on: {
                              click: function($event) {
                                ;(_vm.different_customer = false),
                              ...
                              change: function($event) {
                                _vm.$set(_vm.workorder, "bill_to", "4")
                              }
                            }
                          }),
                        ...
                        _c("label", { staticClass: "radio-inline" }, [
                          _c("input", {
                            ...
                            domProps: {
                              checked: _vm._q(_vm.workorder.bill_to, "2")
                            },
                            on: {
                              click: function($event) {
                                ;(_vm.other_location = true),
                                  (_vm.different_customer = false)
                              },
                              change: function($event) {
                                _vm.$set(_vm.workorder, "bill_to", "2")
                              }
                            }
                          }),
                          _vm._v("Enter Manually")
                        ]),
                        _vm._v(" "),
                        _c("label", { staticClass: "radio-inline" }, [
                          _c("input", {
                            ...
                            domProps: {
                              checked: _vm._q(_vm.workorder.bill_to, "3")
                            },
                            on: {
                              click: _vm.differentCustomer,
                              change: function($event) {
                                _vm.$set(_vm.workorder, "bill_to", "3")
                              }
                            }
                          }),
                          _vm._v("Address from Customer List")
                        ])
                      ])
                    ])
                  : _vm._e(),
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.location_name,
                                expression: "workorder.location_name"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { placeholder: "Location Name" },
                            domProps: { value: _vm.workorder.location_name },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.address,
                                expression: "workorder.address"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { placeholder: "Address" },
                            domProps: { value: _vm.workorder.address },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.city,
                                expression: "workorder.city"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { placeholder: "City" },
                            domProps: { value: _vm.workorder.city },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.state,
                                expression: "workorder.state"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { placeholder: "State" },
                            domProps: { value: _vm.workorder.state },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.zip,
                                expression: "workorder.zip"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { placeholder: "Zip" },
                            domProps: { value: _vm.workorder.zip },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.country,
                                expression: "workorder.country"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { placeholder: "Country" },
                            domProps: { value: _vm.workorder.country },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.workorder.zone,
                                expression: "workorder.zone"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { placeholder: "Zone" },
                            domProps: { value: _vm.workorder.zone },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model.number",
                                  value: _vm.other_customer_id,
                                  expression: "other_customer_id",
                                  modifiers: { number: true }
                                }
                              ],
                              staticClass: "form-control",
                              on: {
                                change: [
                                  function($event) {
                                    ...
                                    _vm.other_customer_id = $event.target
                                      .multiple
                                      ? $$selectedVal
                                      : $$selectedVal[0]
                                  },
                                  function($event) {
                                    _vm.differentCustomerLocation(
                                      _vm.other_customer_id
                                    )
                                  }
                                ]
                              }
                      ...
                      _c("div", { staticClass: "form-group" }, [
                        ...
                        _c("div", { staticClass: "col-md-10" }, [
                          _c(
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model.number",
                                  value: _vm.workorder.customer_location_id,
                                  expression: "workorder.customer_location_id",
                                  modifiers: { number: true }
                                }
                              ],
                              staticClass: "form-control",
                            ...
                            _vm._l(_vm.other_locations, function(
                              another_location
                            ) {
                              return _c(
                                "option",
                                { domProps: { value: another_location.id } },
                                [
                                  _vm._v(
                                    _vm._s(another_location.address) +
                                      ", " +
                                      _vm._s(another_location.name)
                                  )
                                ]
                              )
                            })
                  ...
                  _c("div", { staticClass: "col-md-5" }, [
                    _c(
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.workorder.tax_code_id,
                            expression: "workorder.tax_code_id"
                          }
                        ],
                        staticClass: "form-control",
                        on: {
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm._l(_vm.taxcodes, function(taxcode) {
                          return _c(
                            "option",
                            { domProps: { value: taxcode.id } },
                            [
                              _vm._v(
                                _vm._s(taxcode.rate) +
                                  "% " +
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.contract_id,
                            expression: "workorder.contract_id",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.workorder.purchase_order_no,
                          expression: "workorder.purchase_order_no"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text" },
                      domProps: { value: _vm.workorder.purchase_order_no },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.workorder.is_assigned,
                            expression: "workorder.is_assigned"
                          }
                        ],
                        attrs: { type: "checkbox", value: "1" },
                        domProps: {
                          checked: Array.isArray(_vm.workorder.is_assigned)
                            ? _vm._i(_vm.workorder.is_assigned, "1") > -1
                            : _vm.workorder.is_assigned
                        },
                        on: {
                          change: function($event) {
                            var $$a = _vm.workorder.is_assigned,
                              $$el = $event.target,
                            ...
                            if (Array.isArray($$a)) {
                              ...
                              if ($$el.checked) {
                                $$i < 0 &&
                                  (_vm.workorder.is_assigned = $$a.concat([
                                    $$v
                                  ]))
                              } else {
                                $$i > -1 &&
                                  (_vm.workorder.is_assigned = $$a
                                    .slice(0, $$i)
                                    .concat($$a.slice($$i + 1)))
                              }
                            } else {
                              _vm.$set(_vm.workorder, "is_assigned", $$c)
                            }
                          }
                        }
                      }),
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model.number",
                                value: _vm.workorder.user_ids,
                                expression: "workorder.user_ids",
                                modifiers: { number: true }
                              }
                            ],
                            staticClass: "form-control",
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model.number",
                                  value: _vm.workorder.is_scheduled,
                                  expression: "workorder.is_scheduled",
                                  modifiers: { number: true }
                                }
                              ],
                              attrs: { type: "radio", value: "0" },
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.workorder.start_date,
                                          expression: "workorder.start_date"
                                        }
                                      ],
                                      attrs: { type: "date" },
                                      domProps: {
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.workorder.start_time,
                                              expression: "workorder.start_time"
                                            }
                                          ],
                                          attrs: { type: "time" },
                                          domProps: {
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.workorder.end_date,
                                          expression: "workorder.end_date"
                                        }
                                      ],
                                      attrs: { type: "date" },
                                      domProps: {
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.workorder.end_time,
                                              expression: "workorder.end_time"
                                            }
                                          ],
                                          attrs: { type: "time" },
                                          domProps: {
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model.number",
                                              value: _vm.workorder.is_all_day,
                                              expression:
                                                "workorder.is_all_day",
                                              modifiers: { number: true }
                                            }
                                          ],
                                          attrs: {
                                          ...
                                          on: {
                                            change: function($event) {
                                              ...
                                              if (Array.isArray($$a)) {
                                                ...
                                                if ($$el.checked) {
                                                  $$i < 0 &&
                                                    (_vm.workorder.is_all_day = $$a.concat(
                                                      [$$v]
                                                    ))
                                                } else {
                                                  $$i > -1 &&
                                                    (_vm.workorder.is_all_day = $$a
                                                      .slice(0, $$i)
                                                      .concat(
                                                        $$a.slice($$i + 1)
                                                      ))
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.service_manager_id,
                            expression: "workorder.service_manager_id",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.account_manager_id,
                            expression: "workorder.account_manager_id",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model.number",
                            value: _vm.workorder.related_person_id,
                            expression: "workorder.related_person_id",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass: "form-control",
          ...
          _vm._v(" "),
          _vm.errors != "" && _vm.errors != undefined
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-40799f72", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\WorkOrderAll.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6fefc69b", Component.options)
  } else {
    hotAPI.reload("data-v-6fefc69b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("4444cf02", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6fefc69b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./WorkOrderAll.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6fefc69b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./WorkOrderAll.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_select__ = __webpack_require__(69);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ChangeStatusWorkOrder_vue__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ChangeStatusWorkOrder_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__ChangeStatusWorkOrder_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        changeStatus: __WEBPACK_IMPORTED_MODULE_2__ChangeStatusWorkOrder_vue___default.a
    },
    data: function data() {
        return {
            workOrderDetails: [],
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('work-orders/all').then(function (response) {
            _this.workOrderDetails = response.data;
        });
    },

    methods: {
        toWorkOrder: function toWorkOrder() {
            this.$router.push({ name: 'add-workorder' });
        },
        doSearch: function doSearch() {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('work-orders/all', this.search).then(function (response) {
                _this2.workOrderDetails = response.data;

                if (_this2.search.type == 'id') _this2.placeholder = "put workorder id here";else if (_this2.search.type == 'customer') _this2.placeholder = "put customer name here";else if (_this2.search.type == 'city') _this2.placeholder = "put service Location name here";
            });
        },
        changeStatus: function changeStatus(id, description) {
            this.change = true;
            this.workOrderId = id;
        ...
        deleteWorkOrder: function deleteWorkOrder(id) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('work-order/delete/' + id).then(function (response) {
                _this3.$router.go();
            });
        }
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('work-order/' + this.workOrderId).then(function (response) {
    ...
    methods: {
        changeStatus: function changeStatus() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('work-order/change-status/' + this.workOrderId, { status: this.status, users: this.user_ids }).then(function (response) {
                _this2.$router.go();
            });
        }
    }
      ...
      _c(
        "form",
        {
          ...
          on: {
            submit: function($event) {
              $event.preventDefault()
              _vm.changeStatus($event)
            }
          }
        },
        [
          _c("fieldset", [
            _c("legend", [_vm._v("Change Status")]),
            _vm._v(" "),
            _c("p", [_vm._v(_vm._s(_vm.heading))]),
            _vm._v(" "),
            _c("div", { staticClass: "form-group" }, [
              _c("label", { staticClass: "control-label col-md-2" }, [
                _vm._v("Status")
                      ...
                      "select",
                      {
                        ...
                        on: {
                          change: function($event) {
                            ...
                            _vm.user_ids = $event.target.multiple
                              ? $$selectedVal
                              : $$selectedVal[0]
                          }
                        }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-890b8698", module.exports)
  }
}
            ...
            _c("div", { staticClass: "col-md-2" }, [
              _c(
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.search.stat,
                      expression: "search.stat"
                    }
                  ],
                  staticClass: "form-control",
                  on: {
                ...
                [
                  ...
                  _c("option", { attrs: { value: "1" } }, [_vm._v("New")]),
                  _vm._v(" "),
                  _c("option", { attrs: { value: "2" } }, [_vm._v("Assigned")]),
                  _vm._v(" "),
                  _c("option", { attrs: { value: "3" } }, [
                    _vm._v("Postponed")
                  ]),
                  ...
                  _vm._v(" "),
                  _c("option", { attrs: { value: "5" } }, [_vm._v("Closed")])
                ]
              )
            ])
          ])
        ...
        _c("div", { staticClass: "panel-body" }, [
          _c(
            ...
            [
              ...
              _c(
                "tbody",
                _vm._l(_vm.workOrderDetails, function(workOrderDetail) {
                  return _c("tr", [
                    _c("td", [_vm._v(_vm._s(workOrderDetail.id))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(workOrderDetail.description))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(workOrderDetail.customer.name))]),
                    _vm._v(" "),
                    _c("td", [
                      _vm._v(
                        "\n                        " +
                          _vm._s(workOrderDetail.location.name) +
                          "\n                        "
                      ),
                      _c("p", [
                        _vm._v(
                          _vm._s(workOrderDetail.location.address) +
                            "\n                        "
                        )
                      ]),
                      _c("p", [_vm._v(_vm._s(workOrderDetail.city))])
                    ]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(workOrderDetail.created_at))]),
                    _vm._v(" "),
                    ...
                    _c("td", [
                      _c(
                        "ul",
                        [
                          workOrderDetail.users == ""
                            ? _c("li", [_vm._v("Not Assigned")])
                            : _vm._e(),
                          _vm._v(" "),
                          _vm._l(workOrderDetail.users, function(user) {
                            return _c("li", [_vm._v(_vm._s(user.username))])
                          })
                        ],
                        2
                      )
                              ...
                              _c(
                                "a",
                                {
                                  on: {
                                    click: function($event) {
                                      ;(_vm.isDelete = true),
                                        (_vm.workOrderId = workOrderDetail.id)
                                    }
                                  }
                                },
                                [_vm._v("Delete")]
                    ...
                    _c("div", { staticClass: "modal-footer" }, [
                      ...
                      _c(
                        "button",
                        {
                          ...
                          attrs: { id: "btnDelete", type: "button" },
                          on: {
                            click: function($event) {
                              _vm.deleteWorkOrder(_vm.workOrderId)
                            }
                          }
                        },
                        [_vm._v("Delete")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6fefc69b", module.exports)
  }
}
